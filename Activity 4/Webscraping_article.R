...
url <- 'https://arxiv.org/search/?query=CELLPHONE&searchtype=all&abstracts=show&order=-announced_date_first&size=50'
...
# Export the result
save(papers, file = "webscrape_articles.RData")
write.csv(papers, file = "webscrape_articles.csv")
