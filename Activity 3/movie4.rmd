...
url_template <- 'https://www.imdb.com/title/tt1877832/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
    Movie_Title = rep("X-Men: Days of Future Past", reviews_to_scrape),
